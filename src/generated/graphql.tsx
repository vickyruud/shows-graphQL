...
export type GetCountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', name: string, emoji: string, capital?: string | null, code: string, languages: Array<{ __typename?: 'Language', name?: string | null }> }> };
